...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spec-classes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12593&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spec-classes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spec-classes` can be installed with:

```
conda install spec-classes
```

It is possible to list all of the versions of `spec-classes` available on your platform with:
